...
let florentinoUnlocked = true; // Florentino Ball is now unlocked by default - no secret code needed
let FLORENTINO_DASH_CHANCE = 0.3;
let FLORENTINO_PICK_CHANCE = 0.5;
// "SUBARU" secret code: after a Return by Death ball dies, a small panel lets the
// player type a number of deaths that is added straight to that ball's stacks.
let subaruUnlocked = false;
